...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HashRouter__ = __webpack_require__(80);
...
var authorize_user = exports.authorize_user = function authorize_user(username, role, isLoggedIn) {
...
exports.addPagePermissions = exports.page_permissions = undefined;

var _DemoComponent = __webpack_require__(45);

var _DemoComponent2 = _interopRequireDefault(_DemoComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var page_permissions = exports.page_permissions = [{
	'url': '/demo',
	'component': _DemoComponent2.default,
	'requiredRole': ['admin']
	// },
	// {
	// 	'url': '/employee',
...
var addPagePermissions = exports.addPagePermissions = function addPagePermissions() {
	page_permissions.push.apply(page_permissions, arguments);
};
...
exports.RequireRole = exports.RequireRoleBase = undefined;
...
var RequireRoleBase = exports.RequireRoleBase = function (_Component) {
  _inherits(RequireRoleBase, _Component);

  function RequireRoleBase() {
    _classCallCheck(this, RequireRoleBase);

    return _possibleConstructorReturn(this, (RequireRoleBase.__proto__ || Object.getPrototypeOf(RequireRoleBase)).apply(this, arguments));
  }

  _createClass(RequireRoleBase, [{
    key: 'ensureAuth',
    value: function ensureAuth(props) {
      var isLoggedIn = props.isLoggedIn,
          unauthorizedPath = props.unauthorizedPath,
    ...
    key: 'hasRequiredRole',
    value: function hasRequiredRole(_ref) {
      var requiredRole = _ref.requiredRole,
    ...
    value: function render() {
      ...
      console.log("logged in " + isLoggedIn + " " + (typeof isLoggedIn === 'undefined' ? 'undefined' : _typeof(isLoggedIn)));
...
var RequireRoleConnected = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps)(RequireRoleBase));

var RequireRole = exports.RequireRole = function RequireRole(WrappedComponent) {
  var requireRoleProps = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var unauthorizedPath = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '/forbidden';
  var loginPath = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '/login';

  return function (props) {
    return _react2.default.createElement(
      RequireRoleConnected,
      _extends({}, requireRoleProps, { unauthorizedPath: unauthorizedPath, loginPath: loginPath }),
...
RequireRoleBase.propTypes = {
  ...
  currentUserRole: _propTypes2.default.string,
  requiredRole: _propTypes2.default.array
};

exports.default = (0, _reactRouterDom.withRouter)(RequireRole);
...
exports.authorize_user_reducer = exports.authorize_user = exports.addPagePermissions = undefined;
...
var _RequireRole = __webpack_require__(44);

var _app_page_permissions = __webpack_require__(43);
...
var _authorize_user_reducer = __webpack_require__(42);

var _authorize_user_reducer2 = _interopRequireDefault(_authorize_user_reducer);
...
var Authorizer = function (_Component) {
	_inherits(Authorizer, _Component);

	function Authorizer() {
		_classCallCheck(this, Authorizer);

		return _possibleConstructorReturn(this, (Authorizer.__proto__ || Object.getPrototypeOf(Authorizer)).apply(this, arguments));
	}
	...
	_createClass(Authorizer, [{
		...
		value: function render() {
			...
			console.log;
			var page = _app_page_permissions.page_permissions.map(function (p) {
				console.log(p.url);
				if (p.url !== undefined && p.component !== undefined && p.requiredRole !== undefined) {
					return _react2.default.createElement(_reactRouterDom.Route, { key: p.url, path: '' + _this2.props.match.url + p.url, component: (0, _RequireRole.RequireRole)(p.component, { requiredRole: p.requiredRole }, _this2.props.unauthorizedPath, _this2.props.loginPath) });
				}
				// return null;
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					null,
					page,
					_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: this.props.match.url, component: (0, _RequireRole.RequireRole)(this.props.AuthDefaultRoute, this.props.unauthorizedPath, this.props.loginPath) }),
...
exports.addPagePermissions = _app_page_permissions.addPagePermissions;
exports.authorize_user = _index.authorize_user;
exports.authorize_user_reducer = _authorize_user_reducer2.default;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_MemoryRouter__ = __webpack_require__(31);
// Written in this round about way for babel-transform-imports
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(39), __webpack_require__(93)(module)))
